...
variable "pmdns_list_map" {
  ...
  default = {
    default = {
      ...
      ########## : "10.104.198.250",
      ########## : "10.104.198.251",
      #--------- : "10.104.198.252", used temporarily for baseimage creation (see splunk_provisioning/ansible/baseimage.yml)
    ...
    production = {
      ...
      ########## : "10.104.146.250",
      ########## : "10.104.146.251",
      #--------- : "10.104.146.252", used temporarily for baseimage creation (see splunk_provisioning/ansible/baseimage.yml)
