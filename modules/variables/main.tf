...
variable "pmdns_list_map" {
  ...
  default = {
    default = {
      ...
      ########## : "10.104.198.220",
      ########## : "10.104.198.221",
      #--------- : "10.104.198.222", OTC System interface
      ...
      splw0sy001 : "10.104.198.244",
      splt0sh001 : "10.104.198.245",
      splt0ix001 : "10.104.198.246",
      splt0sy001 : "10.104.198.247",
      ########## : "10.104.198.248",
      ########## : "10.104.198.249",
      ########## : "10.104.198.250",
      ########## : "10.104.198.251",
      ########## : "10.104.198.252",
      ########## : "10.104.198.253",
      #--------- : "10.104.198.254", OTC System interface
    }
    production = {
      ...
      ########## : "10.104.146.63",
      ########## : "10.104.146.64",
      #--------- : "10.104.146.65", OTC System interface
      ...
      ########## : "10.104.146.124",
      ########## : "10.104.146.125",
      #--------- : "10.104.146.126", OTC System interface
      ...
      ########## : "10.104.146.221",
      ########## : "10.104.146.222",
      #--------- : "10.104.146.223", OTC System interface
      ...
      ########## : "10.104.146.252",
      ########## : "10.104.146.253",
      #--------- : "10.104.146.254", OTC System interface
    }
  }
}
output "pmdns_list" {
